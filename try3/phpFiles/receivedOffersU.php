        ...
        echo '<form id="receivedOffersU" method="POST" action="http://localhost/try/phpFiles/receivedOffersU2.php">';
            ...
            foreach ($emails_array as $email) 
            {
                ...
                foreach ($companies as $company) {
                    ...
                    echo '<label class="company-label" for="' . $company['email'] . '">' . $company['email'] . '</label>';
                    echo '<input class="company-checkbox" type="checkbox" id="' . $company['email'] . '" name="usernames[]" value="' . $company['email'] . '">';
                    echo '</div>';
                }
            }
