    ...
    if ($result['concatenated_emails'] !== null) {
        ...
        foreach ($emails_array as $email) {
            ...
            foreach ($companies as $company) {
                ...
                echo '<h3>' . htmlspecialchars($company['companyname']) . '</h3>';
                echo '<p><strong>City:</strong> ' . htmlspecialchars($company['city']) . '</p>';
                echo '<p><strong>About us:</strong> ' . htmlspecialchars($company['about_us']) . '</p>';
                echo '<p><strong>Email:</strong> ' . htmlspecialchars($company['email']) . '</p>';
                echo '<p><strong>Phone:</strong> ' . htmlspecialchars($company['phone']) . '</p>';
                echo '</div>';
            }
        }
